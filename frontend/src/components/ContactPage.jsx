...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(
      `https://wa.me/+923296333301?text=${whatsappMessage}`,
      "_blank",
    );
      ...
      <div className={styles.content}>
        ...
        <div className={styles.cardContainer}>
              ...
              <div className={styles.infoItemContainer}>
                {[
                  ...
                  },
                  {
                    icon: FaEnvelope,
                    label: "Email",
                    value: "sameerprogrammer5@gmail.com",
          ...
          <div className={styles.formCard}>
            <div className={styles.formCircle1} />
            <div className={styles.formCircle2} />

            <div className="mb-4">
              <h2 className={styles.formTitle}>
                <IoSend className={styles.infoIcon} /> Send Your Inquiry
              </h2>
            ...
            <form onSubmit={handleSubmit} className={styles.form}>
                    ...
                    <div key={field} className={styles.inputContainer}>
                      ...
                      {field !== "carType" ? (
                        <input
                          ...
                          className={styles.input(activeFields === field)}
                        />
                      ) : (
                        <select
                          name="carType"
                          ...
                          onBlur={handleBlur}
                          required
                          className={styles.select(activeFields === field)}
                        >
                          <option value="">Select Car Typr</option>
                          {[
                            "Economy",
                            "SUV",
                            "Luxury",
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className={styles.textarea(activeFields === "message")}
                ></textarea>
              </div>
